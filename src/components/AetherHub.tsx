...
export default function AetherHub() {
  ...
  return (
    <section className="relative py-12 px-4 md:px-8 bg-[#020F22] overflow-hidden">
      ...
      {/* 4. Fine Spark/Star particles drifting in the background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 opacity-40">
        <div className="absolute top-[20%] left-[15%] w-1.5 h-1.5 bg-accent-cyan/70 rounded-full animate-float" style={{ animationDelay: '0s', filter: 'blur(1px)' }} />
        ...
        <div className="absolute top-[80%] left-[30%] w-2 h-2 bg-accent-cyan/50 rounded-full animate-float" style={{ animationDelay: '4.5s', animationDuration: '10s', filter: 'blur(1px)' }} />
      </div>

      <div className="container mx-auto max-w-7xl relative z-10">
        {/* Main Gateway Card with interactive glow backing */}
        <div className="relative group">
          {/* Card glow backing - pulses when hover on card */}
          <div className="absolute -inset-1 rounded-[36px] md:rounded-[44px] bg-gradient-to-r from-accent-cyan/15 to-[#0363F8]/15 opacity-40 group-hover:opacity-100 blur-2xl transition-all duration-700 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 relative z-10 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-start">
              ...
              <ul className="flex flex-col gap-4 mb-10 w-full">
                {checkItems.map((item, idx) => (
                  ...
                  >
                    <FiCheckCircle className="text-accent-cyan w-5 h-5 flex-shrink-0 drop-shadow-[0_0_8px_rgba(0,242,255,0.5)]" />
                    <span>{item}</span>
                  </motion.li>
                ))}
              </ul>
              ...
              >
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-accent-cyan text-[#020F22] font-bold text-sm md:text-base shadow-[0_0_25px_rgba(0,242,255,0.3)] hover:shadow-[0_0_35px_rgba(0,242,255,0.6)] hover:scale-105 transition-all duration-300 group"
                >
                  Acessar Aether Hub
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-end justify-center relative">
              ...
              <motion.div
                ...
                className="relative w-[340px] h-[240px] sm:w-[500px] sm:h-[350px] md:w-[600px] md:h-[420px] lg:w-[640px] lg:h-[440px] xl:w-[740px] xl:h-[510px] cursor-pointer z-10 will-change-transform"
              >
                <Image
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-accent-cyan text-[#020F22] font-bold text-sm shadow-[0_0_25px_rgba(0,242,255,0.3)] hover:shadow-[0_0_35px_rgba(0,242,255,0.6)] hover:scale-105 transition-all duration-300 group"
                >
                  Acessar Aether Hub
                  <span className="text-lg transition-transform duration-300 group-hover:translate-x-1.5">→</span>
                </a>
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 justify-items-center">
          {bottomBenefits.map((benefit, idx) => (
            ...
            >
              <div className="p-3 rounded-lg bg-accent-cyan/5 border border-accent-cyan/10 group-hover:border-accent-cyan/30 group-hover:bg-accent-cyan/10 transition-all duration-300">
                {benefit.icon}
              </div>
